...
public class IsoscelesTriangle extends Drawing {
	int place;
	...
	public void move(double x1, double y1) {
		...
		if (isValidPlace(((Rectangle) bound).getX() + x1, ((Rectangle) bound).getY() + y1,
			...
			((Polygon) shape).getPoints().addAll(((Rectangle) bound).getX()+((Rectangle) bound).getWidth()/2,((Rectangle) bound).getY(),((Rectangle) bound).getX(),((Rectangle) bound).getY()+((Rectangle) bound).getHeight(),((Rectangle) bound).getX()+((Rectangle) bound).getWidth(),((Rectangle) bound).getY()+((Rectangle) bound).getHeight());
		}
