...
public class RightTriangle extends Drawing {
	int place;
	...
	public void draw(WorkSpace ws, double x1, double y1) {
		...
		centre = new Circle();
		centre.setRadius(1);
		((Polygon) shape).getPoints().addAll(x1, y1);
	...
	public void move(double x1, double y1) {
		...
		if (isValidPlace(((Rectangle) bound).getX() + x1, ((Rectangle) bound).getY() + y1,
			...
			((Polygon) shape).getPoints().addAll(((Rectangle) bound).getX() ,
					((Rectangle) bound).getY(), ((Rectangle) bound).getX(),
					((Rectangle) bound).getY() + ((Rectangle) bound).getHeight(),
					((Rectangle) bound).getX() + ((Rectangle) bound).getWidth(),
					((Rectangle) bound).getY() + ((Rectangle) bound).getHeight());
		}
	...
	public void resize(double disp_x, double disp_y) {
		...
		if (isValidPlace(((Rectangle) bound).getX(), ((Rectangle) bound).getY(),
			...
			((Polygon) shape).getPoints().clear();
			((Polygon) shape).getPoints().addAll(((Rectangle) bound).getX(),((Rectangle) bound).getY(),((Rectangle) bound).getX(),((Rectangle) bound).getY()+((Rectangle) bound).getHeight(),((Rectangle) bound).getX()+((Rectangle) bound).getWidth(),((Rectangle) bound).getY()+((Rectangle) bound).getHeight());
		}}
	@Override
	public String save() {
